...
typedef struct {
  ...
  ros_slroscpp_internal_block_P_T obj_b;// '<S6>/SinkBlock'
  real_T DiscreteTimeIntegrator1_DSTATE;// '<S2>/Discrete-Time Integrator1'
  real_T DiscreteTimeIntegrator1_PREV_U;// '<S2>/Discrete-Time Integrator1'
  ...
  uint8_T DiscreteTimeIntegrator1_SYSTEM_;// '<S2>/Discrete-Time Integrator1'
...
//  '<S2>'   : 'ghost_integrator/Subsystem1'
//  '<S3>'   : 'ghost_integrator/Subsystem2'
//  '<S4>'   : 'ghost_integrator/Subscribe/Enabled Subsystem'
//  '<S5>'   : 'ghost_integrator/Subsystem1/Blank Message'
//  '<S6>'   : 'ghost_integrator/Subsystem1/Publish'
